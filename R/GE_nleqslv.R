...
GE_nleqslv <- function(beta_vec, mu_vec, cov_vec, MU_ZZ, MU_ZM, MU_ZW, MU_WZ, MU_WM, MU_WW, HOM_vec)
{
	...
	score_eqs <- function(x)
	{
		...
		y[6] = alpha_0*MU_W + alpha_G*MU_GW + alpha_E*MU_EW + alpha_I*MU_GEW + MU_WZ %*% ALPHA_Z + 
